...
/**
 * Main class demonstrating basic Apache Iceberg operations. This example shows how to create tables, work with schemas,
 * and interact with the Iceberg catalog.
 */
