...
/**
 * Example demonstrating data write operations with Apache Iceberg.
 * Shows how to write records to Iceberg tables using the GenericRecord API.
 */
public class DataOperationsExample {
    ...
    private void displayRecordInformation(List<Record> records, Schema schema) {
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            LOG.info("  Record {}: ID={}, Name={}, Email={}, Age={}, Active={}", 
                i + 1,
                record.getField("id"),
